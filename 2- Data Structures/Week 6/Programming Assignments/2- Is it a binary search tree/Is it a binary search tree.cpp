...
#define MY_INT_Minimum (-2147483647 - 1)
#define MY_INT_Maximum 2147483647
...
bool isBST_Helper(const vector<Node> &Tree, const int &nodeIndex, int Minimum, int Maximum)
{
	...
	tightening the Minimum or Maximum constraint */
...
bool IsBinarySearchTree(const vector<Node> &Tree)
{
    ...
    return isBST_Helper(Tree, 0, MY_INT_Minimum, MY_INT_Maximum);
}
